...
class Post {
    ...
    validate() {
        return (this.id >= 0 && 
            ...
            this.likes.every(author => author.validate())
        );
    }
}
...
var posts = [
    ...
    new Post(8, 'Post #8', new Date('2018-12-01T08:53:35'), authors[7], ['hash-8-1', 'hash-8-2', 'hash-8-3'], [authors[4], authors[5]]),
    new Post(9, 'Post #9', new Date('2019-04-11T16:42:42'), authors[8], ['hash-9-1', 'hash-9-2', 'hash-9-3'], []),
    new Post(10, 'Post #10', new Date('2020-12-01T08:53:35'), authors[2], ['hash-9-1', 'hash-9-2'], [authors[2], authors[4], authors[5]]),
